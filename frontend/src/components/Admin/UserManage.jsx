...
const UserManage = () => {
  ...
  const handleRole = async (email) => {
    openConfirmModal(`Are you sure you want to change the role of this user?`, async () => {
      try {
        const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/changeRole`, {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const handleSaveEdit = async (id) => {
    openConfirmModal("Are you sure you want to save the changes?", async () => {
      try {
        const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/updateUser/${id}`, {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const handleDelete = async (id) => {
    openConfirmModal("Are you sure you want to delete this user?", async () => {
      try {
        const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/deleteUser/${id}`, {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
            userid: user?._id
